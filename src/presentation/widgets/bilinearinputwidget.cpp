#include "bilinearinputwidget.h"
#include "../../domain/scaling/bilinearalgorithm.h"

BilinearInputWidget::BilinearInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
BilinearInputWidget::~BilinearInputWidget()
{
...
void BilinearInputWidget::on_execute_button_clicked()
{
    auto algorithm = new BilinearAlgorithm();
...
void BilinearInputWidget::on_cancel_button_clicked()
{
    close();
}
