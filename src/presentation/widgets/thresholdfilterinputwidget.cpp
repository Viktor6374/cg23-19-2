#include "thresholdfilterinputwidget.h"

ThresholdFilterInputWidget::ThresholdFilterInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
ThresholdFilterInputWidget::~ThresholdFilterInputWidget()
{
...
void ThresholdFilterInputWidget::on_execute_button_clicked()
{
    close();
    _editor->update_image_view();
}

void ThresholdFilterInputWidget::on_cancel_button_clicked()
{
    close();
}
