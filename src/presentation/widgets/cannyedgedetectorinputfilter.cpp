#include "cannyedgedetectorinputfilter.h"

CannyEdgeDetectorInputFilter::CannyEdgeDetectorInputFilter(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
CannyEdgeDetectorInputFilter::~CannyEdgeDetectorInputFilter()
{
...
void CannyEdgeDetectorInputFilter::on_execute_button_clicked()
{
    close();
    _editor->update_image_view();
}

void CannyEdgeDetectorInputFilter::on_cancel_button_clicked()
{
    close();
}
