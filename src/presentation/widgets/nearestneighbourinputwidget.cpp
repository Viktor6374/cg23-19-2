#include "nearestneighbourinputwidget.h"
#include "../../domain/scaling/closestneighbouralgorithm.h"

NearestNeighbourInputWidget::NearestNeighbourInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
NearestNeighbourInputWidget::~NearestNeighbourInputWidget()
{
...
void NearestNeighbourInputWidget::on_execute_button_clicked()
{
    auto algorithm = new ClosestNeighbourAlgorithm();
...
void NearestNeighbourInputWidget::on_cancel_button_clicked()
{
    close();
}
