#include "medianfilterinputwidget.h"

MedianFilterInputWidget::MedianFilterInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
MedianFilterInputWidget::~MedianFilterInputWidget()
{
...
void MedianFilterInputWidget::on_execute_button_clicked()
{
    close();
    _editor->update_image_view();
}

void MedianFilterInputWidget::on_cancel_button_clicked()
{
    close();
}
