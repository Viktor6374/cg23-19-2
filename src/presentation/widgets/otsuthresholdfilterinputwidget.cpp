#include "otsuthresholdfilterinputwidget.h"

OtsuThresholdFilterInputWidget::OtsuThresholdFilterInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
OtsuThresholdFilterInputWidget::~OtsuThresholdFilterInputWidget()
{
...
void OtsuThresholdFilterInputWidget::on_execute_button_clicked()
{
    close();
    _editor->update_image_view();
}

void OtsuThresholdFilterInputWidget::on_cancel_button_clicked()
{
    close();
}
