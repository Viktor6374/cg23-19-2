#include "sobelfilterinputwidget.h"

SobelFilterInputWidget::SobelFilterInputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
SobelFilterInputWidget::~SobelFilterInputWidget()
{
...
void SobelFilterInputWidget::on_execute_button_clicked()
{
    close();
    _editor->update_image_view();
}

void SobelFilterInputWidget::on_cancel_button_clicked()
{
    close();
}
