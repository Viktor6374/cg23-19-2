#include "lanczos3inputwidget.h"
#include "../../domain/scaling./lanczos3algorithm.h"

Lanczos3InputWidget::Lanczos3InputWidget(ImageService *service, ImageEditor *editor)
{
    _service = service;
    _editor = editor;
...
Lanczos3InputWidget::~Lanczos3InputWidget()
{
...
void Lanczos3InputWidget::on_execute_button_clicked()
{
    auto algorithm = new Lanczos3Algorithm();
...
void Lanczos3InputWidget::on_cancel_button_clicked()
{
    close();
}
